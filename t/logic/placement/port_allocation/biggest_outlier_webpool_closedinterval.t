...
unless ($ENV{VENN_TEST_NODEPLOY}) {
    ...
    assign_hostport('portrange1', 3, 1025, 48); # ports
    assign_hostport('portrange2', 6, 1075, 10); # ports in same WP
    assign_hostport('portrange3', 9, 1026, 1); # ports in same WP
    assign_hostport('portrange4', 12, 1087, 10); # ports in another WP, same building
    assign_hostport('portrange5', 15, 1099, 10); # ports in another WP, same building
    assign_hostport('portrange6', 39, 1111, 10); # ports in another building, same continent
    assign_hostport('portrange7', 99, 1123, 10); # ports in another continent
...
my $placement = {
    ...
    additional => {
        ports => {
            ...
            min => 10240, # minimum allocation range
            max => 10241, # max allocation range
            sequential => 1,
        },
    },
    attributes => {
