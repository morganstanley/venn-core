...
unless ($ENV{VENN_TEST_NODEPLOY}) {
    ...
    assign_hostport('portrange6', 69, 1099, 10); # hostports in another building, same continent
    assign_hostport('portrange7', 99, 1111, 10); # hostports in another continent
