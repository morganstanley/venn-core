package Venn::Schema::ResultClass::HashRefInflatorFloatConvert;

=head1 NAME

Venn::Schema::ResultClass::HashRefInflatorFloatConvert - Get raw hashrefs from a resultset
and convert scientific notation into floats (to fix a DB2 issue).
...
=head1 SYNOPSIS
 ...
 $rs->result_class('Venn::Schema::ResultClass::HashRefInflatorFloatConvert');
 ...
 my $rs = $schema->resultset('CD')->search({}, {
       result_class => 'Venn::Schema::ResultClass::HashRefInflatorFloatConvert',
     });
 while (my $hashref = $rs->next) {
       ...
 }
...
following:
 ...
 my $cds = $artist->cds;
 $cds->result_class('Venn::Schema::ResultClass::HashRefInflatorFloatConvert');
 my $first = $cds->first;
